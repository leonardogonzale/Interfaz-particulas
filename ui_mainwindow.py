...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionBusqueda_de_Profundidad = QAction(MainWindow)
        self.actionBusqueda_de_Profundidad.setObjectName(u"actionBusqueda_de_Profundidad")
        ...
        self.menuArchivo.addAction(self.actionBusqueda_de_Profundidad)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionBusqueda_de_Profundidad.setText(QCoreApplication.translate("MainWindow", u"Busqueda de Profundidad y amplitud", None))
